...
exports.signIn = async (req,res) => {
    ...
    try {
        ...
        res.status(200).json({messsage: "Signin successful",
            token,
            user: {
                id: user._id,
                email: user.email,
        ...
        console.log(error)
        res.status(500).json ({meassage: "Signin failed", error : error.meassage })
    }
}
...
// send email containing the reset link to reset password email
